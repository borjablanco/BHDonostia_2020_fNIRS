function [A] = BrainNet_spm_matrix(P, order)
% Return an affine transformation matrix
% FORMAT [A] = BrainNet_spm_matrix(P [,order])
% P(1)  - x translation
% P(2)  - y translation
% P(3)  - z translation
...
%
% BrainNet_spm_matrix returns a matrix defining an orthogonal linear (translation,
...
% 4) translation
%
% This order can be changed by calling BrainNet_spm_matrix with a string as a
...
%__________________________________________________________________________
%
% See also: BrainNet_spm_imatrix.m
%__________________________________________________________________________
% Copyright (C) 1994-2011 Wellcome Trust Centre for Neuroimaging

% Karl Friston
% $Id: BrainNet_spm_matrix.m 4414 2011-08-01 17:51:40Z guillaume $
