function V = BrainNet_spm_vol_nifti(P,n)
% Get header information for a NIFTI-1 image
% FORMAT V = BrainNet_spm_vol_nifti(P,n)
...
% John Ashburner
% $Id: BrainNet_spm_vol_nifti.m 6079 2014-06-30 18:25:37Z spm $
...
off = (n(1)-1+dm(4)*(n(2)-1))*ceil(BrainNet_spm_type(dt(1),'bits')*dm(1)*dm(2)/8)*dm(3) + ...
    N.dat.offset;
