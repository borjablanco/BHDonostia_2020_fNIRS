function s = BrainNet_spm_existfile(filename)
% Check if a file exists on disk - a compiled routine
% FORMAT s = BrainNet_spm_existfile(filename)
...
% BrainNet_spm_existfile does not look in MATLAB's search path.
%__________________________________________________________________________
% Copyright (C) 2008-2012 Wellcome Trust Centre for Neuroimaging

% Guillaume Flandin
% $Id: BrainNet_spm_existfile.m 4901 2012-09-05 15:10:48Z guillaume $


%-This is merely the help file for the compiled routine
%error('BrainNet_spm_existfile.c not compiled - see Makefile')
persistent runOnce
if isempty(runOnce)
    warning('BrainNet_spm_existfile is not compiled for your platform.');
    runOnce = true;
end
