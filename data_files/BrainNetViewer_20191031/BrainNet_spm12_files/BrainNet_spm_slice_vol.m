function varargout = BrainNet_spm_slice_vol(varargin)
% Return a section through an image volume - a compiled routine
% FORMAT X = BrainNet_spm_slice_vol(V,A,dim,hold)
% V        -  BrainNet_spm_vol structure
...
%
% BrainNet_spm_slice_vol returns a section through an image volume.
% This section is the transverse slice at z = 0 after linear transformation
% according to matrix A
%
% See also: BrainNet_spm_vol.m, BrainNet_spm_sample_vol.m
%__________________________________________________________________________
% Copyright (C) 1999-2015 Wellcome Trust Centre for Neuroimaging

% John Ashburner
% $Id: BrainNet_spm_slice_vol.m 6340 2015-02-16 12:25:56Z guillaume $


%-This is merely the help file for the compiled routine
error('BrainNet_spm_slice_vol.c not compiled - see Makefile')
