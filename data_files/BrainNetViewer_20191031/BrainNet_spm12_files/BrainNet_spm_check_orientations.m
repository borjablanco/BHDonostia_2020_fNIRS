function [sts, str] = BrainNet_spm_check_orientations(V, verbose)
% Check the dimensions and orientations of the images
% FORMAT [sts, str] = BrainNet_spm_check_orientations(V [,verbose])
% V       - a struct array as returned by BrainNet_spm_vol
...
% John Ashburner
% $Id: BrainNet_spm_check_orientations.m 6894 2016-09-30 16:48:46Z spm $
...
if numel(V) <= 1 || BrainNet_spm_mesh_detect(V), return; end
